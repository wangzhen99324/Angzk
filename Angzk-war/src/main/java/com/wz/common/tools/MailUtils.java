...
public class MailUtils {
	...
	public static final Server DEFAULT_SERVER = new Server("smtp.mxhichina.com", "imap.mxhichina.com", null);
	...
	public static class Server {
		...
		public Server() {
			this("smtp.mxhichina.com", "imap.mxhichina.com", null);
		}
	...
	public static void main(String[] args) {
		Account account = new Account("i18nservice@mianguangroup.com", "");
		System.out.println(send(account, "jiayk@yaocaimaimai.com", "测试邮件", "测试内容"));
	}
}
